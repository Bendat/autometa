import type { ParameterTypeDefinition, ParameterTransformContext } from "@autometa/cucumber-expressions";
 ...
 * These are passed to the fluent builder via .parameterTypes()
 */
