...
Feature: My feature
  ...
  it("should have a scenario as the second child", () => {
    ...
    expect(scenario.children.length).toEqual(2);
    expect(scenario.children[1].hasDocstring).toEqual(false);
    expect(scenario.children[1].hasTable).toEqual(true);
    expect(scenario.children[1].table).toEqual([
      ["a", "b", "c"],
      ["hi", 2, true],
    ]);
  });
  ...
  describe("rule", () => {
    ...
    it("should have a scenario as the second child", () => {
      ...
      expect(scenario.children.length).toEqual(3);
      expect(scenario.children[1].hasDocstring).toEqual(false);
      expect(scenario.children[1].hasTable).toEqual(false);
    });
