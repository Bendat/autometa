...
- fa33083c: Fix `@scope(<group>)` so it does not downgrade module-inferred feature scope when the feature file lives under a configured module directory.
...
- @autometa/vitest-executor@1.0.0-rc.3
...
- Updated dependencies
  ...
  - @autometa/vitest-executor@1.0.0-rc.1
...
> Changelog initialized during the Autometa v1 rewrite. The plugin suite launches for the first time in v1.0.0-rc.0.
